/**
 리액트에서는 실제 dom조작을 사용하지 않길 바람
 (VDOM<->DOM 비교하는 매커니즘때문)
 브라우저 기능을 써야 가능한 경우가 존재0\
 ->대표적으로:focus(),click() 
 */
...
export default function UseRef02() {
  ...
  return (
    ...
    <input type="text"  placeholder="1번" onKeyDown={(e)=>handleKeyDown3(e,input2Ref)} ref={input2Ref} />
    <input type="text"  placeholder="2번"  onKeyDown={(e)=>handleKeyDown3(e,input3Ref)} ref={input3Ref}/>
